    ...
    <div class="card">
      <div class="card-header pdn-20  ">
        <div class="row">
            ...
            @can('users.create')
            <div class="col-md-6">
                <a href="{{route('users.create')}}" class="btn btn-outline-dark float-right text-white btn-lg">
                    <b>CREAR</b> 
            </a>        
            </div>   
            @endcan
                    ...
                    <td width="5%" class="text-center">
                       {{--  <div class="btn-group m-2">
                            ...
                            <div class="dropdown-menu">
                              ...
                              <a data-target="#modal-delete-{{$user->id}}" class="dropdown-item" >Eliminar</a>
                        ...
                        <div class="btn-group pull-right" role="group" aria-label="Basic example">
                          @can('users.show')
                            <a href="{{route('users.show',$user->id)}}" class="btn btn-outline-primary  btn-rounded btn-floating mgn-r-10"  data-toggle="tooltip" data-placement="top" title="VER">
                                <i class="fas fa-search"></i>
                              </a>
                              @endcan
                              @can('users.edit')
                              <a  href="{{route('users.edit',$user->id)}}" class="btn btn-outline-success  btn-rounded btn-floating mgn-r-10" data-toggle="tooltip" data-placement="top" title="EDITAR">
