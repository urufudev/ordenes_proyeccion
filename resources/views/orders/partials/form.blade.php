        ...
        <div class="pdn-15 pdn-sm-20 bdr d-flex flex-column">
            ...
            <div class="row">
                ...
                <div class="col-md-2 mb-3">
                    ...
                    {{Form::date('fecha',$order->fecha ? \Carbon\Carbon::parse($order->fecha)->format('Y-m-d') : null ,['class'=>'form-control  bestupper','autocomplete'=>'off'])}}
                  </div>
                @else
                  <div class="col-md-2 mb-3">
                    <b>{{Form::label('fecha','FECHA')}}</b>
        ...
        <div class="pdn-15 pdn-sm-20 bdr d-flex flex-column">
            ...
            <div class="row">
                ...
                <div class="col-md-4 mb-3">
                    ...
                    {{Form::date('i_vigencia',$order->i_vigencia ? \Carbon\Carbon::parse($order->i_vigencia)->format('Y-m-d') : null ,['class'=>'form-control  bestupper','autocomplete'=>'off'])}}
                  </div>

                  <div class="col-md-4 mb-3">
                    <b>{{Form::label('f_vigencia','FECHA FIN VIGENCIA')}}</b>
                    {{Form::date('f_vigencia',$order->fecha ? \Carbon\Carbon::parse($order->f_vigencia)->format('Y-m-d') : null ,['class'=>'form-control  bestupper','autocomplete'=>'off'])}}
                  </div>
                @else
                <div class="col-md-4 mb-3">
                    <b>{{Form::label('i_vigencia','FECHA INICIO VIGENCIA')}}</b>
