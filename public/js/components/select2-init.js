$(function() {
	...
	//placeholder option
	$(".js-example-placeholder-single").select2({placeholder: "Select a state", allowClear: true});
	...
	$(function() {
		...
		function formatCountry(country) {
			...
			var $country = $('<span class="flag-icon flag-icon-' + country.id.toLowerCase() + ' flag-icon-squared"></span>' + '<span class="flag-text">' + country.text + "</span>");
			return $country;
		};

		$("[name='country']").select2({placeholder: "Select a country", templateResult: formatCountry, data: isoCountries});
	});

	//search minimum 2 value
	$(".example-minimum-input").select2({minimumInputLength: 2, placeholder: "Select a State"});
